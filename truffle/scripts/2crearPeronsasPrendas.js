...
module.exports = async function(callback) {
  try {
    ...
    await retail.almacenarInformacionPersonal("Propietario", "Trabajo Propietario", "URL Propietario", { from: ownerAddr });
    ...
    await retail.crearPrenda("Material1", "Localizacion1","Pantalón","url2" ,{ from: ownerAddr });

    // Obtiene información de la prenda creada por el propietario/administrador
    const infoPrenda = await retail.obtenerInformacionPrenda(2);
